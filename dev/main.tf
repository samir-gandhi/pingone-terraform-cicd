...
# output "BXI_DV_JS_URL" {
#   value = coalesce(
#     resource.pingone_environment.environment.region == "NorthAmerica" ? "https://auth.pingone.com" :"",
#     resource.pingone_environment.environment.region == "Europe" ? "https://auth.pingone.eu" :"",
#     resource.pingone_environment.environment.region == "AsiaPacific" ? "https://auth.pingone.asia" :"",
#     resource.pingone_environment.environment.region == "Canada" ? "https://auth.pingone.ca" :"",
#     )
# }
